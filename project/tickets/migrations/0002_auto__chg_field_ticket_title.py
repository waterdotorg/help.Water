...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ticket.title'
        db.alter_column(u'tickets_ticket', 'title', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Ticket.title'
        db.alter_column(u'tickets_ticket', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
